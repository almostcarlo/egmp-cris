<section role="main" class="content-body">
	...
	<header class="page-header">
		<h2>Lineup List - Website Application</h2>
	</header>

    <!-- start: page -->
    <div class="row">
        <div class="col-md-4">
            <?php echo form_open('recruitment/lists/web_lineup', 'id="frm_lineup"')?>
                <section class="panel">
...
?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="javascript:void(0);" onclick="web_lineup('re', '<?php echo $v['id'];?>');" data-toggle="tooltip" data-placement="top" title="Re-evaluate" data-original-title=""><i class="fa fa-repeat"></i></a>
